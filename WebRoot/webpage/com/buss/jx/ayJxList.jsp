...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="ayJxList" checkbox="true" fitColumns="false" title="绩效表" actionUrl="ayJxController.do?datagrid&sjpzid=${sjpzid}" idField="id" fit="true" queryMode="group" onLoadSuccess="onload">
   ...
   <t:dgCol title="达标奖金"  field="dbjj"  extendParams="editor:{type:'numberbox',options:{precision:2}}"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="超出课时数"  field="cckss"    extendParams="editor:{type:'numberbox',options:{precision:2}}" queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="第一档课时数"  field="dydkss"  extendParams="editor:{type:'numberbox',options:{precision:2}}"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="课时费"  field="ksf"  extendParams="editor:{type:'numberbox',options:{precision:2}}"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="课时奖金"  field="ksjj"   extendParams="editor:{type:'numberbox',options:{precision:2}}" queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="第二档课时数"  field="dedkss2"  extendParams="editor:{type:'numberbox',options:{precision:2}}"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="课时费"  field="ksf2" extendParams="editor:{type:'numberbox',options:{precision:2}}"   queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="课时奖金"  field="ksjj2"  extendParams="editor:{type:'numberbox',options:{precision:2}}"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="第三档课时数"  field="dsdkss3"  extendParams="editor:{type:'numberbox',options:{precision:2}}"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="课时费"  field="ksf3" extendParams="editor:{type:'numberbox',options:{precision:2}}"   queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="课时奖金"  field="ksjj3" extendParams="editor:{type:'numberbox',options:{precision:2}}"   queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="课时费合计"  field="ksfhj"  extendParams="editor:{type:'numberbox',options:{precision:2}}"  queryMode="single"  width="120"></t:dgCol>
   ...
   <%-- <t:dgToolBar operationCode="save" title="保存" icon="icon-save" url="ayJxController.do?saveRows" funname="saveData"></t:dgToolBar>
   <t:dgToolBar operationCode="save" title="提交" icon="icon-ok" url="ayJxController.do?submitRows" funname="saveData"></t:dgToolBar> --%>
...
//导出
function ExportXls() {
	JeecgExcelExport("ayJxController.do?exportXls","ayJxList");
}
