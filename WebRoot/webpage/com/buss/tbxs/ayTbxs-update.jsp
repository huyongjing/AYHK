...
<hp:formvalid formid="formobj" dialog="true" usePlugin="password" styleClass="form-horizontal" layout="table"
              action="ayTbxsController.do?doUpdate" tiptype="1">
    ...
    <div class="row form1">
        <div class="col-sm-12">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <t:dictSelect field="zx" type="list" id="djzclx" dictTable="AY_ZXPZ" readonly="readonly"
                                  dictText="zx" dictField="zxbm"
                                  dictCondition=""
                                  defaultVal="${ayTbxsPage.zx}" hasLabel="false"
                                  title="中心" extendJson="{'class':'form-control','datatype':'*'}" datatype="*"></t:dictSelect>
                ...
                <div class="col-sm-3">
                    <input id="ylbxgscd" name="ylbxgscd" type="text" class="form-control" datatype="/^\d+(\.\d{0,2})?$/"
                           value='${ayTbxsPage.ylbxgscd}'>
                    <span class="Validform_checktip"></span>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input id="sybxgscdbf1" name="sybxgscdbf1" type="text" class="form-control"
                           datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.sybxgscdbf1}'>
                    <span class="Validform_checktip"></span>
                ...
                <div class="col-sm-3">
                    <input id="ylbxgscdbf1" name="ylbxgscdbf1" type="text" class="form-control"
                           datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.ylbxgscdbf1}'>
                    <span class="Validform_checktip"></span>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input id="gsbxgscdbf" name="gsbxgscdbf" type="text" class="form-control"
                           datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.gsbxgscdbf}'>
                    <span class="Validform_checktip"></span>
                ...
                <div class="col-sm-3">
                    <input id="sybxgscdbf" name="sybxgscdbf" type="text" class="form-control" datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.sybxgscdbf}'>
                    <span class="Validform_checktip"></span>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input id="zfgjjgscdbf" name="zfgjjgscdbf" type="text" class="form-control" datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.zfgjjgscdbf}'>
                ...
                <div class="col-sm-3">
                    <input id="ylbxgrcdbf" name="ylbxgrcdbf" type="text" class="form-control" datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.ylbxgrcdbf}'>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input id="sybxgrcdbf2" name="sybxgrcdbf2" type="text" class="form-control" datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.sybxgrcdbf2}'>
                ...
                <div class="col-sm-3">
                    <input id="ylbxgrcdbf2" name="ylbxgrcdbf2" type="text" class="form-control" datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.ylbxgrcdbf2}'>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input id="gsbxgrcdbf" name="gsbxgrcdbf" type="text" class="form-control"
                           datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.gsbxgrcdbf}'>
                    <span class="Validform_checktip"></span>
                ...
                <div class="col-sm-3">
                    <input id="sybxgrcdbf" name="sybxgrcdbf" type="text" class="form-control" datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.sybxgrcdbf}'>
                    <span class="Validform_checktip"></span>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input id="zfgjjgrcdbf" name="zfgjjgrcdbf" type="text" class="form-control" datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.zfgjjgrcdbf}'>
                ...
                <div class="col-sm-3">
                    <input id="gsylbc" name="gsylbc" type="text" class="form-control" datatype="/^\d+(\.\d{0,2})?$/" value='${ayTbxsPage.gsylbc}'>
            ...
            <div class="col-sm-3">
                <t:dictSelect field="hklx" type="list" id="hklx" typeGroupCode="hklx" readonly="readonly"
                              defaultVal="${ayTbxsPage.hklx}" hasLabel="false"
             ...
             <!--
                ...
                <div class="col-sm-3">
                    <t:dictSelect field="xzxs" type="list" id="xzxs" typeGroupCode="xzxs" readonly="readonly"
                              defaultVal="${ayTbxsPage.xzxs}" hasLabel="false"
...
<script src="webpage/com/buss/tbxs/ayTbxs.js"></script>
