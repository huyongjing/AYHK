...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" styleClass="form-horizontal" layout="table" action="ayGsbzController.do?doUpdate" tiptype="1" >
			...
			<div class="row form1">
				<div class="col-sm-12">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input id="dj" name="dj" type="text" class="form-control" value='${ayGsbzPage.dj}' datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/">
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">等级</label>
						</div>
						<label class="col-sm-2 control-label">等级开始金额:</label>
						<div class="col-sm-3">
							<input id="ksje" name="ksje" type="text" class="form-control"  value='${ayGsbzPage.ksje}' datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/">
							<span class="Validform_checktip"></span>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input id="jsje" name="jsje" type="text" class="form-control" value='${ayGsbzPage.jsje}' datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/">
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">等级结束金额</label>
						</div>
						<label class="col-sm-2 control-label">税率:</label>
						<div class="col-sm-3">
							<input id="sl" name="sl" type="text" class="form-control" value='${ayGsbzPage.sl}' datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/">
							<span class="Validform_checktip"></span>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input id="sskcs" name="sskcs" type="text" class="form-control" value='${ayGsbzPage.sskcs}' datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/">
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">速算扣除数</label>
						</div>
						<label class="col-sm-2 control-label">说明:</label>
						<div class="col-sm-3">
							<input id="sm" name="sm" type="text" class="form-control" value='${ayGsbzPage.sm}'>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/buss/gsbz/ayGsbz.js"></script>		
