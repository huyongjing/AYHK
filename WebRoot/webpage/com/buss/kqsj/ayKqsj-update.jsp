...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ayKqsjController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="year" name="year" type="text" style="width: 150px" class="inputxt"  value='${ayKqsjPage.year}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="month" name="month" type="text" style="width: 150px" class="inputxt"  value='${ayKqsjPage.month}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="zxbm" name="zxbm" type="text" style="width: 150px" class="inputxt"  value='${ayKqsjPage.zxbm}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="tjzt" name="tjzt" type="text" style="width: 150px" class="inputxt"  value='${ayKqsjPage.tjzt}'>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/buss/kqsj/ayKqsj.js"></script>		
