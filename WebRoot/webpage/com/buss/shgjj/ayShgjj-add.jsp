...
<hp:formvalid formid="formobj" dialog="true" usePlugin="password" styleClass="form-horizontal" layout="table"
              action="ayShgjjController.do?doAdd" tiptype="1" callback="@Override afterSubmit">
    ...
    <div class="row form1">
        <div class="col-sm-12">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input id="zfgjjhj" name="zfgjjhj" type="text" class="form-control">
                    <span class="Validform_checktip"></span>
                ...
                <div class="col-sm-3">
                    <input id="bxhj" name="bxhj" type="text" class="form-control">
                    <span class="Validform_checktip"></span>
