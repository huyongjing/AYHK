...
<body>
<hp:formvalid formid="formobj" dialog="true" usePlugin="password" styleClass="form-horizontal" layout="table" action="ayZxpzController.do?doAdd" tiptype="1">
    ...
    <div class="row form1">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input id="zx" name="zx" type="text" class="form-control">
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">中心地区</label>
            </div>
            <label class="col-sm-2 control-label">中心编码:</label>
            <div class="col-sm-3">
              <!--   <input id="zxbm" name="zxbm" type="text" class="form-control" datatype="n">  -->
                 <t:dictSelect field="zxbm" type="list" id="zxbm" dictTable="T_S_DEPART"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input id="zsmze" name="zsmze" type="text" class="form-control" datatype="*">
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">正式员工免征额</label>
            </div>
            <label class="col-sm-2 control-label">劳务员工免征额:</label>
            <div class="col-sm-3">
                <input id="lwmze" name="lwmze" type="text" class="form-control" datatype="*">
                <span class="Validform_checktip"></span>
         ...
         <div class="form-group" style="display:none">
            ...
            <div class="col-sm-3">
                <input id="yczd" name="yczd" type="text" class="form-control" datatype="*">
                <span class="Validform_checktip"></span>
