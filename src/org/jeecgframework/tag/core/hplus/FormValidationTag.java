...
public class FormValidationTag extends TagSupport {
    ...
    private SysThemesEnum sysThemesEnum = null;
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            if ("btn_sub".equals(btnsub) && dialog) sb.append("<input type=\"hidden\" id=\"" + btnsub + "\" class=\"" + btnsub + "\"/>");
    ...
    public int doEndTag() throws JspException {
        try {
            ...
            if (layout.equals("div")) {
                ...
                if (tabtitle != null) sb.append("<script type=\"text/javascript\" src=\"plug-in/Validform/js/form.js\"></script>\n");
            }

            //	update-end--Author:longjb  Date:20150323 for：修改增加css主题类属性
            sb.append(StringUtils.replace("<script type=\"text/javascript\" src=\"plug-in/Validform/js/Validform_v5.3.1_min_{0}.js\"></script>\n", "{0}", lang));
            sb.append(StringUtils.replace("<script type=\"text/javascript\" src=\"plug-in/Validform/js/Validform_Datatype_{0}.js\"></script>\n", "{0}", lang));
            sb.append(StringUtils.replace("<script type=\"text/javascript\" src=\"plug-in/Validform/js/datatype_{0}.js\"></script>\n", "{0}", lang));
            if (usePlugin != null) {
                if (usePlugin.indexOf("jqtransform") >= 0) {
                    ...
                    sb.append("<link rel=\"stylesheet\" href=\"plug-in/Validform/plugin/jqtransform/jqtransform.css\" type=\"text/css\">\n");
                }
