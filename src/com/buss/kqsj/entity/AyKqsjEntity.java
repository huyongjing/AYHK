 ...
 */
@Entity
@Table(name = "AY_KQSJ", schema = "")
@SuppressWarnings("serial")
public class AyKqsjEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="FDJ",nullable=true,length=32)
	...
	@Column(name ="CF",nullable=true,length=32)
	...
	@Column(name ="JT",nullable=true,length=32)
