 ...
 */
@Entity
@Table(name = "AY_KCPZ", schema = "")
@SuppressWarnings("serial")
public class AyKcpzEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  系数
	 */
	@Column(name ="XS",nullable=true,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  课程编码
	 */
	@Column(name ="KCBM",nullable=true,length=32)
	public java.lang.String getKcbm(){
		return this.kcbm;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  课程编码
	 */
	public void setKcbm(java.lang.String kcbm){
		this.kcbm = kcbm;
	}
}
