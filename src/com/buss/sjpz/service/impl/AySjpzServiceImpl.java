package com.buss.sjpz.service.impl;
...
@Service("aySjpzService")
@Transactional
public class AySjpzServiceImpl extends CommonServiceImpl implements AySjpzServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(AySjpzEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(AySjpzEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(AySjpzEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(AySjpzEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,AySjpzEntity t){
