 ...
 */
@Entity
@Table(name = "AY_SJPZ", schema = "")
@SuppressWarnings("serial")
public class AySjpzEntity implements java.io.Serializable {
	/**主键*/
